...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-main-bg bg-center bg-no-repeat bg-cover h-screen overflow-hidden font-special">
      ...
      <main className='flex items-center'>
        <div className='h-100 mt-32 w-4/5 md:w-2/3 lg:w-1/2 flex flex-col text-center mx-auto text-white py-24 pb-40 rounded'>
